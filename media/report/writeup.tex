...
\author{Michael Firman, Gabriel Brostow and Simon Julier}
...
\begin{figure}
	...
	\figcaption{The relationship between the various elements of the scene.
	Each region in the image supports many fitted objects, while each fitted object (comprising of a CAD model and a transformation) is supported by just one image region.
	Each fitted object explains many voxels.
	Many camera rays can go through each region, and similarly each camera ray can be associated with many segments due to the soup.}% 
