...
%The data is therefor noisy and 
...
The results from our quantitative analysis are shown in Table \ref{tab:quant_results}.
...
\begin{figure*}
    ...
    \includegraphics[width=0.32\columnwidth, clip=true, trim=30 0 30 110]{data/renders_turn_table/nutrigrain_harvest_blueberry_bliss_NP1_0.mat_bb.jpg}
     ...
     %Column 1: The best case bounding box fitted to the ground truth. Column 2: Voxelisation of the ground truth mesh. Column 3: K-Means forest (might not use these for qualitative results), Column 4: Structured forest.
     }
\end{figure*}
