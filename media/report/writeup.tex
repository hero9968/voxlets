...
\abstract{
	...
	Most existing work to recover the scene geometry relies on combining multiple views of the scene captured from many different directions, or use of \emph{a priori} information about the expected semantic make-up of the scene.
...
\begin{figure*}
	\centering% 
	\includegraphics[width=0.8\linewidth]{pipeline_hor}% 
	\figcaption{The pipeline --- a work in progress!}% 
	\label{fig:input.eps}% 
\end{figure*}
