...
%In our work, we exploit the dense reconstruction of the Kinect Fusion algorithm to extract features directly from the partially complete dense voxel grid.
