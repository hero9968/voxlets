...
\begin{figure}
  ...
  \subfigure[Input depth image]{%
      \includegraphics[width=0.9\columnwidth]{setup_ppt.png}}
      \hfill
  \subfigure[Ground truth output]{%
      \includegraphics[width=0.9\columnwidth]{ground_truth_ppt.png}} \\
...
\begin{figure}
    ...
    The voxel space is a frustum, and each voxel is therefore a prismoidal hexahedron.
