...
#
            ...
            CXXFLAGS="-fno-common -fexceptions -arch $ARCHS -isysroot $MW_SDKROOT -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET -std=c++0x "
            CXXLIBS="$MLIBS -lstdc++"
            CXXOPTIMFLAGS='-O3'
            CXXDEBUGFLAGS='-g'
# -DNDEBUG
...
#
            ...
            LDFLAGS="-arch $ARCHS -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET"
