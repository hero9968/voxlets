...
def loadXform():
    ...
    filename = "./data/likelihood_rotations/rot_" + str(idx) + ".csv"    
...
mainPath = "/Users/Michael/Dropbox/PhD/Projects/RoomExplain/data/rendered_likelihoods2"
...
triangles, verts = loadOBJ("/Users/Michael/Data/Others_data/google_warehouse/obj_beds/BED_simple.obj")
...
def printDepth():
    ...
    scipy.io.savemat(mainPath + "/depth_" + str(idx) + ".mat", dico)
    print "mat written"
