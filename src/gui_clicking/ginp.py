...
base_path = '/home/michael/projects/shape_sharing/src/real_data/oisin_house/tests/extraction_check/'
...
voxlet_gt_ims = [imread(base_path + 'voxlets/compiled_%03d.png' % f) for f in range(N)]
voxlet_ims = [imread(base_path + 'voxlets/predicted_%03d.png' % f) for f in range(N)]
