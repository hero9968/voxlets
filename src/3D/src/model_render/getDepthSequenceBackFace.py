...
scene = args[1]			# name of the scene
radius = float(args[2])	# typically 1
startIdx = int(args[3]) # typically 1
...
savePath =   "/Users/Michael/projects/shape_sharing/data/3D/basis_models/render_backface/"
