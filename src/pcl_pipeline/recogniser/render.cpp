...
std::vector<Eigen::Vector3f> getCamPositions()
{
  std::vector<Eigen::Vector3f> cam_positions;
  
  cam_positions.resize (42);
  cam_positions[0] = Eigen::Vector3f (float (-0.850651), float (0.000000), float (-0.525731));
  cam_positions[1] = Eigen::Vector3f (float (-1.000000), float (0.000000), float (0.000000));
  cam_positions[2] = Eigen::Vector3f (float (-0.850651), float (0.000000), float (0.525731));
  cam_positions[3] = Eigen::Vector3f (float (-0.809017), float (-0.500000), float (-0.309017));
  cam_positions[4] = Eigen::Vector3f (float (-0.809017), float (-0.500000), float (0.309017));
  cam_positions[5] = Eigen::Vector3f (float (-0.809017), float (0.500000), float (-0.309017));
  cam_positions[6] = Eigen::Vector3f (float (-0.809017), float (0.500000), float (0.309017));
  cam_positions[7] = Eigen::Vector3f (float (-0.525731), float (-0.850651), float (0.000000));
  cam_positions[8] = Eigen::Vector3f (float (-0.525731), float (0.850651), float (0.000000));
  cam_positions[9] = Eigen::Vector3f (float (-0.500000), float (-0.309017), float (-0.809017));
  cam_positions[10] = Eigen::Vector3f (float (-0.500000), float (-0.309017), float (0.809017));
  cam_positions[11] = Eigen::Vector3f (float (-0.500000), float (0.309017), float (-0.809017));
  cam_positions[12] = Eigen::Vector3f (float (-0.500000), float (0.309017), float (0.809017));
  cam_positions[13] = Eigen::Vector3f (float (-0.309017), float (-0.809017), float (-0.500000));
  cam_positions[14] = Eigen::Vector3f (float (-0.309017), float (-0.809017), float (0.500000));
  cam_positions[15] = Eigen::Vector3f (float (-0.309017), float (0.809017), float (-0.500000));
  cam_positions[16] = Eigen::Vector3f (float (-0.309017), float (0.809017), float (0.500000));
  cam_positions[17] = Eigen::Vector3f (float (0.000000), float (-1.000000), float (0.000000));
  cam_positions[18] = Eigen::Vector3f (float (0.000000), float (-0.525731), float (-0.850651));
  cam_positions[19] = Eigen::Vector3f (float (0.000000), float (-0.525731), float (0.850651));
  cam_positions[20] = Eigen::Vector3f (float (0.000000), float (0.000000), float (-1.000000));
  cam_positions[21] = Eigen::Vector3f (float (0.000000), float (0.000000), float (1.000000));
  cam_positions[22] = Eigen::Vector3f (float (0.000000), float (0.525731), float (-0.850651));
  cam_positions[23] = Eigen::Vector3f (float (0.000000), float (0.525731), float (0.850651));
  cam_positions[24] = Eigen::Vector3f (float (0.000000), float (1.000000), float (0.000000));
  cam_positions[25] = Eigen::Vector3f (float (0.309017), float (-0.809017), float (-0.500000));
  cam_positions[26] = Eigen::Vector3f (float (0.309017), float (-0.809017), float (0.500000));
  cam_positions[27] = Eigen::Vector3f (float (0.309017), float (0.809017), float (-0.500000));
  cam_positions[28] = Eigen::Vector3f (float (0.309017), float (0.809017), float (0.500000));
  cam_positions[29] = Eigen::Vector3f (float (0.500000), float (-0.309017), float (-0.809017));
  cam_positions[30] = Eigen::Vector3f (float (0.500000), float (-0.309017), float (0.809017));
  cam_positions[31] = Eigen::Vector3f (float (0.500000), float (0.309017), float (-0.809017));
  cam_positions[32] = Eigen::Vector3f (float (0.500000), float (0.309017), float (0.809017));
  cam_positions[33] = Eigen::Vector3f (float (0.525731), float (-0.850651), float (0.000000));
  cam_positions[34] = Eigen::Vector3f (float (0.525731), float (0.850651), float (0.000000));
  cam_positions[35] = Eigen::Vector3f (float (0.809017), float (-0.500000), float (-0.309017));
  cam_positions[36] = Eigen::Vector3f (float (0.809017), float (-0.500000), float (0.309017));
  cam_positions[37] = Eigen::Vector3f (float (0.809017), float (0.500000), float (-0.309017));
  cam_positions[38] = Eigen::Vector3f (float (0.809017), float (0.500000), float (0.309017));
  cam_positions[39] = Eigen::Vector3f (float (0.850651), float (0.000000), float (-0.525731));
  cam_positions[40] = Eigen::Vector3f (float (1.000000), float (0.000000), float (0.000000));
  cam_positions[41] = Eigen::Vector3f (float (0.850651), float (0.000000), float (0.525731));
...
std::cout << "At point number 5.4" << std::endl;
      /////////////////////////////////////
...
std::cout << "At point number 6" << std::endl;
#else 
  ...
  std::cout << "At point number 7" << std::endl;
}
