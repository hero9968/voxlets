    ...
    template<typename PointInT>
      ...
      public:
        ...
        loadOrGenerate (std::string & dir, std::string & model_path, ModelT & model)
        {
          ...
          {
            std::cout << "loading ply for  " << model_path << std::endl;
            ...
            std::cout << "Filter scale" << std::endl;
            ...
            std::cout << "Getting views" << std::endl;
            ...
            std::cout << "Loading or generating" << std::endl;
        ...
        generate (std::string & training_dir)
        {
          ...
          for (size_t i = 0; i < files.size (); i++)
          {
            ...
            std::cout << "loading or generating " << model_path.str() << std::endl;
