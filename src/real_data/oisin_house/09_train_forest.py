...
assert os.path.exists(pca_savepath)
assert os.path.exists(masks_pca_savepath)
...
# model.save(paths.voxlet_model_oma_path.replace('.pkl', '_cobweb_deep25_new_medoid.pkl'))
# model.save('/tmp/small.pkl')
